...
if (!$url || !$albumID) : 
	...
	<div class="bandcamp-block-message">
		<div style="display:block;text-align:center">
			...
			<span>'. esc_html__('BANDCAMP ALBUM ID REQUIRED','blocks-for-bandcamp') .'</span><br>
		</div>
	</div>';
	return;
endif;
...
<div <?php echo wp_kses_post(!$is_editor ? $wrapper_attributes : ''); ?>>
	...
	<section id="<?php echo esc_attr($blockID); ?>" class="bandcamp-merch">
		...
		<ul class="bandcamp-merch-layout-<?php echo esc_attr($layout_style); ?> bandcamp-merch-columns-<?php echo esc_attr($layout_columns); ?>">
